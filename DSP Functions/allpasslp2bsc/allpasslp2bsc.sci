...
//Example: Design the allpass mapping filter changing the lowpass filter with cutoff frequency at Wo=0.6 to the complex–valued bandstop filter with cutoff frequencies at Wt1=0.3 and Wt2=0.4.
//
//                  Wo = 0.6; Wt = [0.3 0.4];
